...
/*$(document).ready(function(){
    ...
    $('#slides .slide').each(function(i){
        ...
        //totWidth += $(this).width();
        totWidth += $('#gallery').width();

        $('#slides .slide img').width($('#gallery').width());
...
function shuffle() {
  ...
  setInterval(function(){
	...
	"Carpe Diem - 존 키팅",
	"휴대폰을 보면 지금도 남아있는 / 「좋아합니다」 / 단 한마디의 미송신 문자 - ?",
	...
	"나는 사람들을 사랑하는 것보다, 더 중요한 예술은 없다고 생각한다. - 반 고흐",
	"인생이란 결코 공평하지 않다. 이 사실에 익숙해져라 - 빌게이츠",
	"도전은 인생을 흥미롭게 만들며, 도전의 극복이 인생을 의미있게 한다. - 제임스 딘",
	"굉장한 적을 만났다. 아내다. 너같은 적은 생전 처음이다. - 조지 고든 바이런",
	"마누라는 매일 같이 똑같은 소리만 지껄이는 고장난 축음기와 같다. - 토마스 에디슨",
	"기회는 작업복을 입고 찾아온 일감처럼 보여서 사람들 대부분이 이를 놓치고 만다. - 토머스 에디슨",
	"시간이 해결해 준다는 말이 있지만, 실제로 일을 변화시켜야 하는 것은 바로 당신이다. - 앤디 워홀",
	"일찍 자고 일찍 일어나면 건강해질 수도 있고, 부유해질 수도 있으며, 지혜로워질 수도 있다. - 벤자민 프랭클린",
	"위대한 업적을 이루려면 활동을 하는데 만족해서는 안되고 반드시 꿈을 꿔야 한다. - 아나톨 프랑스",
	"힘은 희망을 가지는 사람들에게 있고 용기는 속에 있는 의지에서 잃어나는 것이다. - 펄벅",
	"기회는 새와 같은 것, 날아가지 전에 꼭 잡아라. - 쉴러",
	"사람의 얼굴은 하나의 풍경이다. 한권의 책이다. 용모는 결코 거짓말을 하지 않는다. - 받자크",
	"자기 자신이 해낸 것을 즐기는, 그리고 지기 자신이 하고 있는 것을 즐기는 사람은 행복한 사람이다. - 괴테",
	"순간을 지배하는 사람이 인생을 지베한다. - 에센바흐",
	"웃음이 적은 곳에는 매우 적은 성공밖에는 있을 수가 없다. - 엔드류 카네기",
	"이 세상에서 가장 행복한 사람은 일하는 사람, 사랑하는 사람, 희망이 있는 사람이다. - 조셉 에디슨",
	"서둘지 말라. 그러나 쉬지도 말라. - 괴테",
	"우리가 어느 날 마주칠 불행은 우리가 소홀히 보낸 지난 시간에 대한 보복이다. - 나폴레옹",
	"가야할 때가 언제인가를 분명히 알고 가는 이의 뒷모습은 얼마나 아름다운가. - 이형기",
	"친구를 고르는 데는 천천히, 친구를 바꾸는 데는 더욱 천천히 - 밴자민 프랭클린",
	"과거는 기억이 아니라, 해석이다. - Memento",
	...
	"가정과 가정 생활의 안전과 향상이 문명의 중요 목적이요, 산업의 궁극적 목적이다. - C.W.엘리어",
	...
	"걱정없는 인생을 바라지 말고 걱정에 물들지 않는 연습을 하라. - 알랭 - 프랑스 철학자",
	"건강과 부는 미를 창조한다. - H.G.보운",
	"건강과 지성은 인생의 두가지 복이다. - 메난드로스",
	"건강은 행복의 어머니이다. - 프란시스 톰슨",
	"건강한 신체에 건강한 정신. - 유베날리스",
	"검약은 훌륭한 소득이다. - 에라스무스",
	"겁쟁이는 죽음에 앞서서 여러 차례 죽지만 용기있는 자는 한번밖에 죽지 않는다. - 셰익스피어",
	...
	"결혼은 자손 만대의 시작이다. - 예기",
	"결혼이란, 독립은 동등하고 의존은 상호적이며, 의무는 상반되는 남녀간의 관계이다. - L.K.안스파",
	...
	"겸손은 범인에게는 한갓 성실이지만, 위대한 재능의 소유자인 사람에게는 위선이다. - W.셰익스피어",
	...
	"공정하고 바른데는 근거를 두었다면 긍지보다 이익을 주는 것은 좀처럼 없다. - 밀턴",
	...
	"과도한 재산을 소유하게 되었을 때보다 더 시련을 당하게 되는 적은 없다. - 레우왈레이스",
	...
	"사랑한다는 것은 다시 태어난다는 것이다. - 크리스티앙 자크",
	...
	"나는 완미한 덕보다 융통성 있는 악덕을 더 사랑한다. - 모리에르",
	...
	"당신의 정신을 위대한 사상으로 기르라. 영웅을 믿는 일이 영웅을 만들어 낸 다. - 밴자민 디즈렐리",
	"당신이 누군가를 배반 한다면, 당신은 또한 당신 자신을 배반하는 셈이다. - 싱거",
	...
	"두 사람의 개성의 만남은 두가지 화확물질의 접촉과 같다, 반응이 있으면 둘 다 변화한다. - 융",
	"두 사람의 머리는 한 사람의 머리보다 낫다. - 헤이우드",
	"두 여인을 화합시키기 보다는 유럽 전체를 화합시키는 편이 쉽다. - 루이 14세",
	...
	"만물의 근원은 불. - 헤라클레이토스 - Herakleiros",
	"만물의 근원은 원자. - 데모크리토스 - Demokritos",
	"만약 급히 서두르려면 돌아 가는 길로 가라. - 영국속담",
	"만약 제군이 돈의 가치를 알고 싶으면 나가서 얼마간의 돈을 빌려 보라. - 프랭클린",
	"만약 평화가 명예로써 유지되지 못한다면, 그런 평화는 아무런 가치도 없다. - 러셀",
	...
	"모든 일은 계획으로 시작하고, 노력으로 성취되며, 오만으로 망친다. - 관자",
	...
	"분별없고 능력도 없고, 또 사려도 없는 자에게는 등산만큼 위험한 것은 없 다. - C E 마슈즈",
	...
	"사고는 수염과 같은것이다. 성장하기 전에는 나오지 않는다. - 볼테르",
	"사나이 뜻을 세워 집을 나가면 공을 이루지 않고서는 살아서 돌아 오지 않으리. - 매헌 윤봉길",
	...
	"사람은 삶이 두려워서 사회를 만들었고 죽은미 두려워서 종교를 만들었다. - 스펜서",
	"사람은 여자로 태어나지 않는다. 여자로 자라는 것이다. - 보봐르",
	"사람은 자기 일보다 남의 일을 더 잘 알고 더 잘 판단한다. - 테린티우스",
	...
	"사랑은 시간을 가게 하고 시간은 사랑을 가게 한다. - 프랑스 속담",
	...
	"사랑은 홍역과 같은 것이다. 나이가 들어서 걸리면 걸릴수록 중증을 나타낸 다. - 윌리암 제롤드",
	...
	"산이 높을수록 풀은 낮다. - 풀러",
	"살아가는 기술이란 하나의 공격 목표를 골라 그리로 힘을 집중시키는 일이 다. - 앙드레 모로아",
	"살아있는 실패작은 죽은 걸작보다 낫다. - 버나드 쇼",
	"살아있는 인간이 죽은 사람보다 더 자선을 필요로 한다. - G 아놀드",
	...
	"선행을 하고도 나쁜 말을 듣는 사람은 행복하다. - 마르쿠스 아우렐리우스",
	"성공으로 통하는 길은 자신의 남편을 믿고 있는 여자들로 혼잡하기 이를 데 없다. - 쇼",
	...
	"세상에서 가장 아름다운 것은 물론 세상 그 자체이다. - 스티븐슨",
	"세상이 당신에게 준 것보다 더 많이 세상에게 주어라. - 헨리포드",
	"소년이여, 야망을 가져라. Boys, be ambitious. - 클라크 - Clark",
	...
	"슬픔은 현자의 교사임에 틀림없이 없다. 왜냐하면 슬픔은 지식이므로. - 바 이어런",
	"슬픔을 지니고 있는 사람은 행복하다. 그들은 위로를 받을 수 있기 때문에. - 성서",
	"습관은 제2의 천성으로 제1의 천성을 파괴한다. - 블레즈 파스칼",
	"습관은 제 2 의 천성으로 제 1 의 천성을 파괴한다. - 파스칼",
	...
	"아무것도 버릴 수 없는 자는 아무것도 느낄 수 없다. - 프리드리히 빌헬름 니체",
	...
	"왔노라, 보았노라, 이겼노라. - 율리어스 카이사르",
	"왕은 배이고 민중은 물이다. 물은 큰 배를 띄우기도 하고 뒤엎기도 한다. - 순자",
	...
	"우리가 우리의 행위를 결정하는 것처럼 우리의 행위는 우리가 결정한다. - 엘리어트",
	...
	"인간은 진리에 대해서는 얼음같이 차지만, 허위에 대해서는 불과 같이 뜨거 워진다. - 라 퐁떼에느",
	"인간은 천에 따라서 자기 옷을 지어야 한다. - 내쉬",
	"인간은 패배하였을 때 끝나는 것이 아니다. 포기 했을 때 끝나는 것이다. - 닉슨",
	"인간은 항상 시간이 모자란다고 불평을 하면서 마치 시간이 무한정 있는 것처럼 행동한다. - 세네카",
	"인간은 환경을 창조하고 환경은 인간을 창조한다. - 밝은사회",
	"인격은 당신의 아이들에게 남겨줄 수 있는 최대의 유산이다. - 아놀드 그라소우",
	"인간은 신의 걸작품이다. - 퀼즈",
	"인간은 아직까지도 모든 컴퓨터중에서 가장 후륭한 컴퓨터이다. - 케네비",
	"인간을 자유롭게 할 수 있는 것은 오직 이성 뿐이다. - 레프 니콜라예비치 톨스토이 - 러시아 작가",
	"인간의 가장 행복한 시간은 일에 몰두하고 있을 때이다. -  ",
	"인간의 고독감은 삶의 공포일 뿐이다. - 오닐",
	"인간의 눈은 그의 현재를 말하며 입은 그가 앞으로 될 것을 말한다. - 골즈워디",
	"인간의 진정한 재산은 그가 이 세상에서 행하눈 선행인 것이다. - 마호메드",
	"인간이란 미소와 눈물 사이를 왕래하는 시계추와 같은 것이다. - 바이어런",
	...
	"인생의 상대는 돈이 아니다. 우리들의 상대는 인간이다. - 푸시킨",
	"인생의 어려움은 선택에 있다. - 무어",
	"인생의 위대한 목표는 지식이 아니라 행동이다. - 토머스 헨리 헉슬리 - 영국 자연과학자",
	"인생의 참된 목적은 영원히 생명을 깨닫는데 있다. - 톨스토이",
	"인생이란 느끼는 자에게는 비극, 생각하는 자에게는 희극이다. - 라 브뤼에르",
	"인위로 천하를 다스리려고 하는 것은 바다가 강을 걸어서 건너려고 하는 것 과 같다. - 장자",
	"일반적이고 추상적인 관념은 인류의 가장 큰 잘못의 근원이다. - 장 자크 루소 - 프랑스 사상가",
	...
	"자비는 가정에서부터, 정의는 이웃에 서부터 시작한다. - 찰스 디킨스 - Charles",
	...
	"작은 성공을 만족스럽게 생각한는 사람은 큰 성공을 얻지 못한다. - 제세 메서 게만",
	...
	"전쟁에서는 오직 한 번 죽지만은 정치에서는 여러번 죽는다. - 처칠",
	...
	"정사의 경험이 단 한번도 없다는 여인은 있지만 한번 밖에 없다는 여인은 드물다. - 라 로시푸코",
	...
	"죽음은 사람을 슬프게 한다. 삶의 3 분의 1 을 잠으로 보내는 주제에. - 바이런",
	...
	"지식인은 정치가를 경멸하고 정치가는 지식인을 경멸한다. - 로망 로랑",
	"지식인은 지금까지 일어났던 일을 안다. 천재는 앞으로 일어날 일을 안다. - 치이다",
	"지혜는 간혹 누더기 가면을 덮어쓰고 있다. - 스타티우스",
	"지혜는 고통을 통해서 생긴다. - 아에스킬루스",
	"지혜없는 힘은 그 자체의 무게 때문에 쓰러진다. - 호라티우스",
	"지혜의 가장 명백한 징조는 쉴새없이 명랑한 것이다. - 몽테뉴",
	"진리는 인간이 보존하고 있는 최고의 것이다. - 쵸오서어",
	"진리는 많은 말을 필요로 하지 않는다. - 이 언",
	"진리는 적이건 아군이건 모두 초월한다. - 쉴러",
	"진보로 통하는 가장 훌륭한 길은 자유의 길이다. - 존 피츠제럴드 케네디",
	"진실없는 삶이란 있을 수가 없다. 진실이란 삶 그 자체인 것이다. - 카프카",
	"진실은 아름답다. 익살만 없다면, 거짓말도 마찬가지다. - 랠프 월도 에머슨",
	"진실은 정당한 명분을 결코 해치지 않는다. - 마하트마 간디 - 인도의 성인",
	...
	"창조는 고민속에서 나오고 발전은 고생 속에서 움튼다. - 밝은사회",
	...
	"큰일을 목적하는 자는 또한 큰 고통을 당해야한다. - M.L.크랏수스.플루타르쿠스 [영웅전]",
	"클레오파트라의 코가 조금만 낮았더라면 대지의 표면은 바뀌어졌을 것이다. - 파스칼",
	...
	"한가한 인간은 고인 물처럼 끝내 썩어 버린다. - 프랑스 명언",
...
(function($){
    ...
    */
    ...
    if(rand*100 > 50)
      ...
      return String.fromCharCode((rand * 11172) + 0xAC00);
	}
